    ...
    return (
        <Container disableGutters className="cont" style={{
            ...
            <Box sx={{maxWidth: '640px', pt: 10, pb: 30}}>
                ...
                <Box component="div" className="row justify-content-md-center mb-3">
                    <Typography variant="body1" component="span" className="col-lg-9 themed-grid-col text-center"> Простой сайт, который
                ...
                <Box >
                    <Typography component="span" variant="body1" className="col-lg-8 themed-grid-col text-center">
                        Подробнее с функционалом можно познакомиться на странице
                        <Typography component="span" fontWeight="bold" onClick={() => navigate("/help")}
                        sx={{
                            cursor: "pointer",
                            color: 'info.main',
                        }}
