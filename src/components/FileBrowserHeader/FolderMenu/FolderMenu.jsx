...
export const FolderMenu = ({anchorEl, handleCloseMenu}) => {
    ...
    const handleInputChange = (e, isFolder) => {
        ...
        // In UUID-based architecture, we just pass files directly without path info
    ...
    const fileMenu = () => {
        return ([
            <List key="upload" sx={{minWidth: '350px'}} disablePadding component="nav" aria-label="main mailbox folders">
            ...
            <Divider key="div-1" sx={{mb: '14px', pt: 1}}/>,

            <List key="create" sx={{minWidth: '350px'}} disablePadding component="nav" aria-label="main mailbox folders">
                <ListSubheader id="nested-list-subheader"
                               sx={{
                                   backgroundColor: 'transparent',
                                   backdropFilter: 'blur(9px)',
