...
export const FileMenu = ({anchorEl, handleCloseMenu, showViewVariants = true}) => {
    ...
    const fileMenu = () => {
        return ([
            showViewVariants && (
                <List key="view-list" sx={{minWidth: '350px'}} disablePadding component="nav" aria-label="main mailbox folders">
            ...
            showViewVariants && <Divider key="div-view" sx={{mb: '14px', pt: 1}}/>,

            <List key="sort-list" sx={{minWidth: '350px'}} disablePadding component="nav" aria-label="main mailbox folders">
                <ListSubheader id="nested-list-subheader"
                               sx={{
                                   backgroundColor: 'transparent',
                                   backdropFilter: 'blur(9px)',
